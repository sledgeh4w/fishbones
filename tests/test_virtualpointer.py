...
@pytest.mark.parametrize('source_data,read_offset,read_type,expected', [
...
@pytest.mark.parametrize('source_data,write_offset,write_value,expected', [
    (bytearray([71, 114, 97, 118, 105, 116, 117, 109]), 2, uint32(0x53683477),
